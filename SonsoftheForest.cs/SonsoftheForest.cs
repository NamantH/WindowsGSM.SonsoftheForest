...
namespace WindowsGSM.Plugins
{
    public class SonsoftheForest : SteamCMDAgent
    {
        ...
        {
            name = "WindowsGSM.SonsoftheForest", // WindowsGSM.XXXX
            author = "NamantH",
            description = "WindowsGSM plugin for supporting Sons of the Forest Dedicated Server",
            version = "1.0",
            url = "https://github.com/NamantH/WindowsGSM.SonsoftheForest", // Github repository link (Best practice)
            color = "#34c9eb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => true;
        public override string AppId => "2465200"; // Game server appId
        ...
        public override string StartPath => @"SonsOfTheForestDS.exe"; // Game server start path
        public string FullName = "Sons of the Forest Dedicated Server"; // Game server FullName
        ...
        public string Port = "8766"; // Default port
